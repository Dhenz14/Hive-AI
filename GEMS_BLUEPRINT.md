...
| Technique | Trigger to Activate | Paper |
|-----------|-------------------|-------|
| DOC/OSFT (Dynamic Orthogonal CL) | If MoLoRA hits cross-adapter interference | arXiv 2509.23893 |
| RFT/GRPO (RL Fine-Tuning) | After executable eval gates are robust for all 6 languages | arXiv 2507.05386 |
| TreeLoRA (Hierarchical LoRA Org) | When active adapter count exceeds 5 | arXiv 2506.10355 |
| SEE (Sequential Ensemble of Experts) | ALREADY MATCHES our architecture conceptually — no new code needed | arXiv 2504.06664 |
